...
class AdminController extends Controller
{
    ...
    public function kycApp()
    {
		...
		$data['users']=User::where('kyc_link', '!=', '')->get();
        return view('admin.user.kyc', $data);
    }
    ...
    public function Manageuserbvn($id, $bvn)
    {
        $data['client']=$user=User::find($id);
        $data['title']=$user->name;
        $token = round(microtime(true));
        $data['bvndetail']= $this->rubies->verifyBVN($user->kyc_bvn, $token);
        
        return view('admin.user.verify_bvn', $data);
    }
    ...
    public function Manageuser($id)
    {
        ...
        $data['bnk']=UserBank::whereUser_id($user->id)->first();
    ...
    public function logout()
    {
        ...
        return redirect('/varstech_admin');
    }
