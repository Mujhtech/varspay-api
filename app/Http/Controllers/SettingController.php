...
class SettingController extends Controller
{
    ...
    public function EmailUpdate(Request $request)
    {
        ...
        $data->aemessage=$request->aemessage;
        $res=$data->save();
        if ($res) {
    ...
    public function SettingsUpdate(Request $request)
    {
        ...
        $data->estoreweb_api=$request->estoreweb_api;
        $data->paystack_apikey = $request->paystack_apikey;
        $data->paystack_secretkey = $request->paystack_secretkey;
        $data->clubkonnect_user_id = $request->clubkonnect_user_id;
        $data->clubkonnect_api_key = $request->clubkonnect_api_key;
        
        $data->providus_secret_key = $request->providus_secret_key;
        $data->providus_api_key = $request->providus_api_key;
        $data->providus_source_acct_no = $request->providus_source_acct_no;
        $data->providus_contract_code = $request->providus_contract_code;
        
        $data->rubies_secret_key = $request->rubies_secret_key;
        $data->rubies_api_key = $request->rubies_api_key;
